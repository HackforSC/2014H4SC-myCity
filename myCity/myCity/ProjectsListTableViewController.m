//
//  ProjectsListTableViewController.m
//  myCity
//
...
@interface ProjectsListTableViewController ()

@property(nonatomic,strong)NSArray *projects;

@end

@implementation ProjectsListTableViewController
...
-(void)setCurrentInterest:(MyCityInterest *)currentInterest
{
    _currentInterest = currentInterest;
    
    self.title = _currentInterest.name;
...
-(void)reloadData
{
    _projects = _currentInterest.projects;
    
    __weak ProjectsListTableViewController *weakSelf = self;
    ...
    [imageView setImageWithURL:[NSURL URLWithString:_currentInterest.photoUrl] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MyCityProject *currentLocation = _projects[indexPath.row];
